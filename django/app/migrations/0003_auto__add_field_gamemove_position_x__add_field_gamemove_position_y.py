...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GameMove.position_x'
        db.add_column(u'app_gamemove', 'position_x',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=11),
                      keep_default=False)

        # Adding field 'GameMove.position_y'
        db.add_column(u'app_gamemove', 'position_y',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=11),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GameMove.position_x'
        db.delete_column(u'app_gamemove', 'position_x')

        # Deleting field 'GameMove.position_y'
        db.delete_column(u'app_gamemove', 'position_y')
    ...
    models = {
        ...
        u'app.gamemove': {
            ...
            'position_x': ('django.db.models.fields.IntegerField', [], {'max_length': '11'}),
            'position_y': ('django.db.models.fields.IntegerField', [], {'max_length': '11'})
        },
        u'auth.group': {
